...
class Ui_MyWindow(Ui_MainWindow):
    ...
    def new_order_clean_all(self):
        ...
        self.tableWidget.setStyleSheet("QWidget {background-color: rgb(240, 240, 240)}")
        self.current_client_rate = 'normal'
    ...
    def find_previous_orders(self):
        ...
        if previous_orders:
            ...
            self.is_previous_orders = False
        self.label_InBlackList.setText('')
        if self.current_client_rate == 'blacklist':
            self.tableWidget.setStyleSheet("QWidget {background-color: rgb(255, 200, 200)}")
        elif self.current_client_rate == 'perfect':
            self.tableWidget.setStyleSheet("QWidget {background-color: rgb(200, 255, 200)}")
    ...
    def save_warranty_or_order_change(self):
        ...
        elif self.radioButtonClientRatePerfect:
